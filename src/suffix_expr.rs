...
impl<'a, T: Fragmentable> Add<T> for SuffixExpr<'a, Escaped> {
...
impl<'a, T: Fragmentable> Sub<T> for SuffixExpr<'a, Escaped> {
...
impl<'a, T: Fragmentable> BitOr<T> for SuffixExpr<'a, Escaped> {
...
impl<'a, T: Groupable> Rem<T> for SuffixExpr<'a, Escaped> {
