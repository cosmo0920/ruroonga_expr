...
fn nested_logicals_expr() {
    ...
    let llexpr = phrase_expr("Rust lang").column("language").prepare();
    let lrexpr = phrase_expr("Haskell lang").column("language").prepare();
    ...
    let rlexpr = phrase_expr("Ruby lang").column("language").prepare();
    let rrexpr = phrase_expr("Python lang").column("language").prepare();
